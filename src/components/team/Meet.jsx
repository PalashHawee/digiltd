  ...
  return (
    <div className="bg-gradient-to-b from-customBlue-800 to-customGreen-800 text-white py-16 px-6 md:px-20">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-gradient-to-b from-customBlue-800 to-customGreen-800 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-lg">
        ...
        <div className="bg-gradient-to-b from-customBlue-800 to-customGreen-800 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-lg">
          ...
          <p className="text-lg text-white-700 mt-4">
            ...
            role as Director of Nagorik TV, USA-based Bangladeshi news channel.
          </p>
        </div>
      ...
      <div className="text-center mt-10">
        <p className="text-lg text-white-700">
          Engr. Abedin's journey is a true testament to the power of passion,
          leadership, and resilience. She continues to inspire many by leading
          with integrity and driving positive change across industries.
        </p>
      </div>
    </div>
  );
...
export default AboutFarzanaAbedin;
